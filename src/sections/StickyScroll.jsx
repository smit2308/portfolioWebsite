...
const StickyScroll = () => {
    ...
    return (
      ...
      <motion.div
        ...
        //   backgroundColor: backgroundColors[activeCard % backgroundColors.length],
        // }}
        className="h-[640px]  w-full  overflow-y-scroll hide-scrollbar flex flex-row-reverse justify-center gap-20     xl:px-16 "
        ref={ref}
      >       
            ...
            {workFeatured.map((item, index) => (
              <div key={item.title + index} className="my-20 ">
                <motion.h2
                  ...
                  className="lg:text-2xl sm:text-xl font-bold text-secondary"
                >
                  {item.title}
                </motion.h2>
                <motion.p
                  ...
                  className=" text-secondary font-montserrat text-xs sm:text-sm lg:text-lg font-light leading-normal mt-10"
                >
